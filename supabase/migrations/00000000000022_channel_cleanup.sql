...
ALTER TABLE IF EXISTS bapx.channel_configs
  DROP COLUMN IF EXISTS session_strategy;

DO $$ BEGIN
  IF to_regclass('bapx.channel_configs') IS NOT NULL THEN
    ALTER TABLE bapx.channel_configs
...
DROP TYPE IF EXISTS bapx.session_strategy;
