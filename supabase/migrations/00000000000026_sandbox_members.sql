CREATE TABLE IF NOT EXISTS "bapx"."sandbox_members" (
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_sandbox_members_unique"
  ON "bapx"."sandbox_members" ("sandbox_id", "user_id");
CREATE INDEX IF NOT EXISTS "idx_sandbox_members_user"
  ON "bapx"."sandbox_members" ("user_id");
CREATE INDEX IF NOT EXISTS "idx_sandbox_members_sandbox"
  ON "bapx"."sandbox_members" ("sandbox_id");

INSERT INTO "bapx"."sandbox_members" ("sandbox_id", "user_id", "added_by")
SELECT s."sandbox_id", am."user_id", NULL
FROM "bapx"."sandboxes" s
JOIN "bapx"."account_members" am
