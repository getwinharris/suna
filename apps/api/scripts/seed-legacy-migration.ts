 ...
 *   2. Spins up a Daytona sandbox with the OLD bapX snapshot
 ...
 *
 * Requires:
 *   - DATABASE_URL (legacy bapX DB with projects/threads/messages/resources tables)
...
async function main() {
  ...
  console.log('4. Creating Daytona sandbox with old bapX snapshot...');
