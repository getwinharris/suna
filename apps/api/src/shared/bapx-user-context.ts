/**
 * Signed user-context header sent from the preview proxy to bapx-master.
 *
...
export function encodeBapxUserContext(
  ctx: Omit<BapxUserContext, 'iat' | 'exp'> & { ttlSeconds?: number },
  secret: string,
): string {
...
export type BapxUserContextVerifyResult =
