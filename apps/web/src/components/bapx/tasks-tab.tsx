...
import { TaskKanban } from '@/components/bapx/task-kanban';
import { TaskList } from '@/components/bapx/task-list';
import type {
  BapxTask,
  BapxTaskStatus,
...
const VIEW_STORAGE_KEY = 'bapx:tasks-view';
...
interface TasksTabProps {
  tasks: BapxTask[];
  filteredTasks: BapxTask[];
  search: string;
  setSearch: (v: string) => void;
  searchRef: React.RefObject<HTMLInputElement | null>;
  onStartTask: (id: string) => void;
  onApproveTask: (id: string) => void;
  onOpenTask: (task: BapxTask) => void;
  onNewTask: (status?: BapxTaskStatus) => void;
