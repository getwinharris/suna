      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] text-muted-foreground">
            <span>© {currentYear} Bapx Media Hub</span>
            ...
            <a href="https://status.bapx.in" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">Status</a>
          </div>

          <div className="flex items-center gap-1.5">
            {/* GitHub */}
            <a href="https://github.com/bapx-ai/bapX" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
            ...
            {/* X */}
            <a href="https://x.com/bapx" target="_blank" rel="noopener noreferrer" aria-label="X"
              className="flex items-center justify-center size-6 rounded text-muted-foreground hover:text-foreground transition-colors">
              <svg viewBox="0 0 24 24" className="size-3" fill="currentColor">
