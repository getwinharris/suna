...
import { isHiddenTool } from '@bapx/shared/tools';
...
interface BapxComputerProps {
  ...
  /** When true, BapxComputer skips rendering its own PanelHeader (tabs are provided externally, e.g. by SessionLayout). */
  hideTopBar?: boolean;
