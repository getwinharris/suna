...
export const WallpaperBackground = memo(function WallpaperBackground({
  ...
  // ── Variant 1: Brandmark ──────────────────────────────────────────────
  // Full-bleed oversized Bapx symbol outline, faded
  ...
  // ── Variant 2: Symbol ─────────────────────────────────────────────────
  // Tiny Bapx symbol, dead center, ghost-level opacity
  ...
  if (wallpaper.type === 'aurora') {
    return (
      ...
      >
        ...
        {/* L2 — Bapx logomark, sized relative to the actual container so
