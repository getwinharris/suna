...
const stackStudies = [
  {
    ...
    rows: [
      ...
      ['Bapx Media Hub orchestration', 'Memory, integrations, scheduling, tunnels'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['Bapx Media Hub keeps it organized', 'Cron, routing, memory, integrations'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['Bapx Media Hub', 'Routes intent and keeps memory coherent'],
          ...
          <div>
            <Reveal delay={0.03}>
              ...
              <h1 className="mt-4 max-w-4xl text-4xl font-medium tracking-tight text-foreground sm:text-5xl md:text-6xl">
                A calmer way to evaluate how Bapx Media Hub should explain itself.
              </h1>
