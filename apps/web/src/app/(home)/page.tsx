      ...
      <div className="relative bg-background">
        ...
        <div className="sticky top-0 h-dvh overflow-hidden z-0">
          ...
          >
            ...
            <div className="relative z-[1] pb-8 px-4 flex flex-col items-center gap-6">
              ...
              >
                Launch Your Bapx Media Hub<ArrowRight className="ml-1.5 size-3.5" />
              </Button>
              <button
                onClick={handleCopy}
            ...
            <div className="rounded-xl overflow-hidden border border-border/50 bg-card/20 shadow-sm">
              <div className="relative aspect-video bg-black">
                <iframe
                  ...
                  title="Bapx Media Hub launch video"
          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-4 max-w-xl">
                Every tool your company uses — OAuth apps, MCP servers, REST APIs, CLI tools, environment variables. If it has an interface, Bapx Media Hub connects to it. 3,000+ integrations available, and custom ones are trivial to add.
              </p>
        ...
        >
          ...
          <Button
            ...
            onClick={handleLaunch}
          >
            Launch Your Bapx Media Hub<ArrowRight className="ml-1.5 size-3" />
          </Button>
        </div>
      </div>
    </BackgroundAALChecker>
