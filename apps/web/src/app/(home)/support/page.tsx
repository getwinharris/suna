      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 sm:pt-32 pb-24 sm:pb-32">
        ...
        <Reveal delay={0.08}>
          <p className="text-base text-muted-foreground leading-relaxed max-w-xl">
            Email us at{' '}
            <a href="mailto:support@bapx.in" className={linkClass}>support@bapx.in</a>.
        ...
        <Reveal>
          <div className="mt-14">
            ...
            <div>
              <FAQItem
                question="What is Bapx Media Hub?"
              ...
              />
              <FAQItem
                question="How is Bapx Media Hub different from other AI platforms?"
                answer="Most AI platforms are chat interfaces that give you suggestions. Bapx Media Hub is a persistent computer that runs agents autonomously — they browse the web, execute code, call APIs, manage files, and coordinate across your tools. They work while you sleep."
              />
              <FAQItem
                question="Can Bapx Media Hub connect to my apps?"
                answer="Yes. 3,000+ integrations via OAuth, MCP servers, REST APIs, CLI tools, and environment variables. If it has an interface, Bapx Media Hub connects to it."
              />
              <FAQItem
                question="How do I request a feature or report a bug?"
                answer={
                  <>Email <a href="mailto:support@bapx.in" className={linkClass}>support@bapx.in</a> with details. For bugs, include steps to reproduce and any error messages. Screenshots help.</>
                }
              />
              <FAQItem
                question="What if I don't get credits after paying?"
                answer={
                  <>Contact <a href="mailto:support@bapx.in" className={linkClass}>support@bapx.in</a> immediately. We prioritize billing issues and typically resolve them within a few hours.</>
                }
              />
            </div>
          </div>
        ...
        <Reveal>
          <div className="mt-14 pt-8 border-t border-border">
            ...
            <div className="flex flex-col gap-1.5 mt-3">
              <a href="mailto:support@bapx.in" className={`text-base ${linkClass} w-fit`}>
                support@bapx.in
              </a>
              <a href="mailto:security@bapx.in" className={`text-base ${linkClass} w-fit`}>
                security@bapx.in
              </a>
            </div>
          </div>
