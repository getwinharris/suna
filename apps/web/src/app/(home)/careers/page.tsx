...
export const metadata: Metadata = {
  ...
  keywords:
    'Bapx Media Hub careers, Bapx Media Hub jobs, AI startup jobs, autonomous company jobs, San Francisco AI jobs, agent engineering, startup hiring',
  openGraph: {
    title: 'Careers at Bapx Media Hub – Build the Autonomous Company OS',
    description:
    ...
    url: 'https://www.bapx.in/careers',
    images: [
      {
        url: '/images/careers/shackleton.png',
        width: 380,
        height: 253,
        alt: 'Careers at Bapx Media Hub',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.bapx.in/careers',
  },
};
