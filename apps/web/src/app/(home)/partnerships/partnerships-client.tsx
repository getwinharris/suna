      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 sm:pt-32 pb-24 sm:pb-32">
        ...
        <Reveal delay={0.08}>
          <p className="text-base text-muted-foreground leading-relaxed max-w-xl">
            We work with a handful of selected companies to build autonomous operations — the same way we build them for ourselves. Bapx Media Hub leadership and engineers, embedded with your team.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.2}>
          <div className="mt-14 p-6 rounded-lg border border-border bg-muted/5">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Bapx Media Hub leadership and engineers embedded with your team. Cancel anytime.
            </p>
          </div>
        </Reveal>
