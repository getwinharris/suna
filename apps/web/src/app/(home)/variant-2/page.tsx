        ...
        <div ref={heroRef} className="relative h-[250vh]">
          ...
          >
            ...
            >
              ...
              >
                Launch Bapx Media Hub<ArrowRight className="ml-2 size-4" />
              </Button>
          ...
          <div className="max-w-3xl mx-auto px-6 pt-24 sm:pt-32 pb-10 sm:pb-14">
            ...
            <Reveal delay={0.1}>
              <p className="mt-4 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl">
                A Bapx Media Hub is a cloud computer where AI agents do the actual work of running a company. You connect your tools, define your agents, set their schedules and triggers — and the machine operates whether you&apos;re there or not. Persistent memory that compounds. A workforce that never stops.
              </p>
            </Reveal>
          </div>
              ...
              <div>
                ...
                <Reveal delay={0.1}>
                  <p className="text-base text-muted-foreground leading-relaxed mb-8">
                    Bapx Media Hub runs on <a href="https://opencode.ai" target="_blank" rel="noopener noreferrer" className="hover:text-foreground/80 transition-colors">OpenCode</a>, an open foundation for building knowledge work agents, with the Bapx Media Hub cognitive architecture layered on top. Everything is just files.
                  </p>
                </Reveal>
                <Reveal delay={0.2}>
                ...
                <div className="rounded-2xl overflow-hidden border border-border/40 bg-card/20 font-mono text-[11px]">
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="space-y-2 pl-3 border-l border-border/25">
                      <div className="text-muted-foreground text-[0.5625rem] uppercase tracking-widest mb-3">Bapx Media Hub</div>
                      {[
