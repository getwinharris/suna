                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <div className="text-muted-foreground mb-6 space-y-2">
                        <p>
                          <strong>Bapx Media Hub AI Corp</strong>
                        </p>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Bapx Media Hub AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY Bapx Media Hub AI
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE Bapx Media Hub
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to Bapx Media Hub AI Corp, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the Bapx Media Hub website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the Bapx Media Hub platform and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@bapx.in
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        Bapx Media Hub is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to legal@bapx.in and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@bapx.in. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the Bapx Media Hub Public
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All Bapx Media Hub logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE Bapx Media Hub WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        Bapx Media Hub DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        <strong>Mailing Address:</strong> Bapx Media Hub AI Corp, 701 Tillery
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at Bapx Media Hub in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        Bapx Media Hub does not collect biometric or identifying
