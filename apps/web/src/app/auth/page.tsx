  ...
  return (
    <div className="bg-background/75 dark:bg-background/70 backdrop-blur-2xl border border-foreground/[0.08] rounded-2xl p-9 max-w-md w-full">
      ...
      <form className="space-y-3.5">
        ...
        <textarea
          name="useCase"
          placeholder="What will you build with Bapx Media Hub?"
          rows={3}
                    ...
                    <form className="space-y-3">
                      ...
                      <div className="flex items-center gap-2.5 pt-0.5">
                        ...
                        <label htmlFor="gdprConsent" className="text-[11px] leading-[1.6] text-foreground/30 cursor-pointer select-none">
                          I agree to the{' '}
                          <a href="https://www.bapx.in/legal?tab=privacy" target="_blank" rel="noopener noreferrer" className="text-foreground/45 hover:text-foreground/65 transition-colors">
                            Privacy Policy
                          </a>
                          {' & '}
                          <a href="https://www.bapx.in/legal?tab=terms" target="_blank" rel="noopener noreferrer" className="text-foreground/45 hover:text-foreground/65 transition-colors">
                            Terms
                          </a>
                        </label>
                      </div>
      ...
      <AnimatePresence>
        {phase === 'lock' && (
          ...
          >
            ...
            >
              <div className="flex flex-col items-center gap-1.5">
                <p className="text-foreground/50 text-sm font-medium tracking-wide">Bapx Media Hub</p>
