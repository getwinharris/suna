/**
 * Adapter: OpenCode SDK ToolPart → BapxComputer ToolCallInput
 *
 * Converts OpenCode session messages into the ToolCallInput[] format
 * that BapxComputer expects, enabling the computer panel to display
 * OpenCode tool calls.
 */

import type { MessageWithParts, ToolPart, ToolState } from '@/ui';
import type { ToolCallInput } from '@/components/thread/bapx-computer/BapxComputer';
 ...
 * the ToolCallInput[] format used by BapxComputer.
 */
