 ...
 *
 * Mirrors the canonical task statuses exposed by the live /bapx/tasks API.
 */
...
export const STATUS_META: Record<BapxTaskStatus, StatusMeta> = {
  todo: {
    icon: Circle,
...
export const ALL_STATUSES: BapxTaskStatus[] = [
  'todo',
  'in_progress',
  'input_needed',
  'awaiting_review',
