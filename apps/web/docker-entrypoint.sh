...
# Support both NEXT_PUBLIC_* (legacy) and BAPX_PUBLIC_* (current) naming.
RUNTIME_SUPABASE_URL="${NEXT_PUBLIC_SUPABASE_URL:-${BAPX_PUBLIC_SUPABASE_URL:-}}"
RUNTIME_ANON_KEY="${NEXT_PUBLIC_SUPABASE_ANON_KEY:-${BAPX_PUBLIC_SUPABASE_ANON_KEY:-}}"
RUNTIME_BACKEND_URL="${NEXT_PUBLIC_BACKEND_URL:-${BAPX_PUBLIC_BACKEND_URL:-}}"
RUNTIME_BILLING="${NEXT_PUBLIC_BILLING_ENABLED:-${BAPX_PUBLIC_BILLING_ENABLED:-false}}"
