...
```sh
NEXT_PUBLIC_TRAILBASE_URL=https://your-project.trailbase.co
NEXT_PUBLIC_TRAILBASE_ANON_KEY=your-anon-key
...
- Trailbase is used for authentication and database operations
