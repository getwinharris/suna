 ...
 * 
 * Note: The backend should return bapx.in URLs that wrap/proxy Stripe,
...
// checkout URLs (should be bapx.in masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a bapx.in masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.bapx.in/subscription';
