...
const SSH_META_KEY = 'bapx:ssh-access-meta:v1';
          ...
          {sshResult && (
            <View className="mt-5" style={{ gap: 20 }}>
              ...
              <CodeSection
                ...
                description="Add this to your SSH config, then connect with: ssh bapx-sandbox"
                code={configCmd}
...
const TOKEN_COLORS = {
  ...
  path: '#86EFAC',      // emerald-300 — paths like ~/.ssh/bapx_sandbox
