...
If the subject gives no clear color signal AND the user provided no direction after being asked, fall back to the Bapx HSL values from `skills/GENERAL-KNOWLEDGE-WORKER/website-building/shared/01-design-tokens.md` → "Bapx HSL Equivalents" section.
