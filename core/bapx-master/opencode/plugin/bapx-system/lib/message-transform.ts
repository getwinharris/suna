...
export const BAPX_SYSTEM_OPEN_TAG = "<bapx_system"
export const BAPX_SYSTEM_CLOSE_TAG = "</bapx_system>"

/**
 * Check if text contains any bapx_system XML tags.
 */
export function containsBapxSystemTags(text: string): boolean {
	return text.includes(BAPX_SYSTEM_OPEN_TAG) && text.includes(BAPX_SYSTEM_CLOSE_TAG)
}
...
export function wrapInBapxSystemTags(
	...
	return `${BAPX_SYSTEM_OPEN_TAG}${attrString}>${content}${BAPX_SYSTEM_CLOSE_TAG}`
}
