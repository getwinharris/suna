...
const WORKSPACE_ROOT = process.env.BAPX_WORKSPACE || "/workspace";
...
const WATCHDOG_INTERVAL_MS = Number(
  process.env.BAPX_SERVICE_WATCHDOG_INTERVAL_MS || 5_000,
);
const RECOVERY_THROTTLE_MS = Number(
  process.env.BAPX_SERVICE_RECOVERY_THROTTLE_MS || 4_000,
);
...
const INNER_DOCKER_ENABLED = process.env.BAPX_ENABLE_INNER_DOCKER !== "0";
